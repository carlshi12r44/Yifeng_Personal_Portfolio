          ...
          <div className="timeline-content">
            ...
            <p>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0">
                  Implement UI components for user-growth and user-registration
                  features using React JS and Google Maps API
                </li>
                <li class="list-group-item border-0">
                  Implement backend routes for user’s login security and user’s
                  posts feed features using Flask and SQL database
                </li>
                <li class="list-group-item border-0">
          ...
          <div className="timeline-content">
            ...
            <p>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0">
                  Incorporate with other developers on discovering and analyzing
                  unique users on the company’s platform
                </li>
              </ul>
            </p>
          </div>
          ...
          <div className="timeline-content">
            ...
            <p>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0">
                  Formatted the date format to be standard and easy to parse in
                  the dataset
                </li>
                <li class="list-group-item border-0">
                ...
                <li class="list-group-item border-0">
                  Visualized top 5 popular bikeshare stations every month using
                  folium
                </li>
              </ul>
            </p>
          ...
          <div className="timeline-content">
            ...
            <p>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0">
                  Deployed mapper to split the input phrases as keys and output
                  N-Gram of the following phrases
                </li>
                <li class="list-group-item border-0">
                  Deployed reducer to collect the mappers’ outputs and sort the
                  top 10 results and wrote them to the database
                </li>
                <li class="list-group-item border-0">
                  Ran the MapReduce job with Hadoop under a docker container to
                  generate the auto completion results
                </li>
              </ul>
            </p>
          </div>
            ...
            <p>
              <ul class="list-group">
                ...
                <li class="list-group-item border-0">
                  ...
                  feature vectors and transformed the occurrences to frequencies
                  and built a pipeline function to combine the tokenizing and
                  transformation functions
                </li>
                <li class="list-group-item border-0">
                  Trained the dataset with Random Forest classifier to obtain an
                  accuracy of 79% by using Scikit-Learn in Python
                </li>
                <li class="list-group-item border-0">
